# This code is all lifted from the Trac project
...
def _modification_callback(file):
...
def main(func, modification_callback, *args, **kwargs):
    ...
    if modification_callback is None:
        modification_callback = _modification_callback
